  ...
  return (
    ...
    >
      <div className="text-center">
        {/* スピナーアニメーション */}
        <div className="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-primary-600" />
      ...
      <div className="text-center">
        <div className="mx-auto mb-6 h-16 w-16">
          ...
          <div className="grid h-16 w-16 grid-cols-2 gap-2">
            <div className="animate-pulse rounded bg-primary-200" />
            <div
              className="animate-pulse rounded bg-primary-300"
            ...
            />
            <div
              className="animate-pulse rounded bg-primary-200"
